...
const SingleProperties: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-[5rem]">
        ...
        <div className="grid lg:grid-cols-5 grid-cols-1 lg:gap-x-5 gap-y-5">
          ...
          <div className="col-span-3">
            ...
            <div>
              <Image
                src={property.images[selectedImage]} // <-- use selectedImage index
                alt={property.name}
                width={400}
                height={200}
      ...
      {/* Modal */}
      {showModal && (
        <div className="fixed inset-0 z- flex justify-center mt-20 items-start backdrop-blur-md bg-opacity-40">
          <div
          ...
          >
            <button
              className={`absolute top-4 right-6 text-3xl font-bold transition-colors duration-200
            ...
            {submitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className={`rounded-lg px-6 py-2 mt-4 font-semibold text-lg transition
                    ${isDarkMode
